...
def gmap_alignment(input_contigs, output_file):
    ...
    cmd = ("/projects/btl/arch/gmap-2014-01-21/bin/gmap -d hg19 "
    "-D /projects/btl/arch/gmapdb_sarray/hg19/ {} "
    "-t {} -f samse -O -x 10 -n 0 | "
    "grep -v chrM | "
    "/projects/btl/arch/samtools view -bhS - -o {}").format(input_contigs, str(args.threads), output_file)
...
pipeline_run(multiprocess=2, touch_files_only=False, history_file=".history_file=.ruffus.command2", checksum_level=1)
